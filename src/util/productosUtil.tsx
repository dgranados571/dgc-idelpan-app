import imagen1 from '../img/pan_1.jpg'
import imagen2 from '../img/pan_2.jpg'
import imagen3 from '../img/pan_3.jpg'
import imagen4 from '../img/pan_4.png'
import imagen5 from '../img/pan_5.jpg'

const productosUtil = () => {

    const productosDetalle: { [key: string]: { nombre: string; PxC: number; valorPaquete: number, valorCanasta: number, urlImage: string } } = {
        'IP_Prod_001': {
